...
_.first = function(array, number){
    ...
    if(!Array.isArray(array) || number < 0 ){
        ...
        let output = array.splice(0, number);
        return output;
    }
};
...
_.last = function(array, number){
    ...
    if(!Array.isArray(array) || number < 0 ){
        ...
        for(let i = lastIndex; i >= number - 1; i--){
...
_.reject = function(array, action){
    //creating new array
    var result = _.filter(array, function(element, index, array){
        return(action(element, index, array) === false)
    });
    return result;
};
    ...
    if (initialValue !== undefined){
       var result = initialValue;
        ...
        for(var i = 1; i <= array.length - 1; i++){
            result = callbackFunction(result, array[i], i);
        }
    }
    return result;
};
